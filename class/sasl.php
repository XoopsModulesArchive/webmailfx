...
<class>
	...
	<version>@(#) $Id: sasl.php,v 1.7 2004/10/05 03:58:06 mlemos Exp $</version>
...
*/
	Function Start($mechanisms, &$message, &$interactions)
	{
		...
		$this->error=(strlen($no_mechanism_error) ? $no_mechanism_error : "it were not requested any of the authentication mechanisms that are supported");
		return(SASL_NOMECH);
	}
/*
{metadocument}
